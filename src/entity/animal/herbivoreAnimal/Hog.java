...
public class Hog extends Herbivore {
    ...
    public final int MAX_COUNT_ON_FIELD = 50;
    ...
    public final int CHANCE_EAT_MOUSE = 50;
    ...
    public void eat(ArrayList<Object> objectArrayList) {
        ...
        for (int k = 0; k < objectArrayList.size(); k++) {
            ...
            for (int i = 0; i < ListTypeAnimals.PLANT_ARRAY_LIST.size(); i++) {
                ...
                if (simpleNameClass.equals("Caterpillar") || simpleNameClass.equals("Mouse")) {
                    try {
